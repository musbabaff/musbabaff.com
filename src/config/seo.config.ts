...
export const PERSON = {
  ...
  name: {
    first: "Mustafa",
    last: "Babayev",
    full: "Mustafa Babayev",
    display: "Mustafa Babayev",
    alternativeNames: ["Mustafa", "musbabaff", "Mustafa Babayev", "musiqusi"],
  },
  username: "musbabaff",
  email: "musbabaff@gmail.com",
  birthDate: "1999-10-11", // Format: "YYYY-MM-DD" e.g., "1995-05-15"
  birthPlace: {
    city: "Baku",
    country: "Azerbaijan",
  },
  ...
  // Bio & Description
  bio: {
    short: "A Software Developer from Baku, Azerbaijan",
    medium:
      "A Software Developer specializing in building high-performance web applications using React, Next.js, Node.js, and Laravel.",
    long: "Mustafa Babayev is a Software Developer from Baku, Azerbaijan, specializing in building high-performance and elegant web applications using React, Node.js, Laravel, and other modern web technologies.",
  },
...
export const SITE = {
  // Domain & URLs
  domain: process.env.NEXT_PUBLIC_BASE_DOMAIN || "musbabaff.com",
  get url() {
...
export const SCHEMA = {
  ...
  person: {
    ...
    nationality: {
      ...
      sameAs: "https://en.wikipedia.org/wiki/Azerbaijan",
    },
    homeLocation: {
      "@type": "Place" as const,
