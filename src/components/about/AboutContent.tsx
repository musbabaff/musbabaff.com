...
const defaultAboutData: AboutHeroData = {
    ...
    paragraphs: [
        ...
        'With 15+ years of experience, I leverage tools like <strong class="text-foreground">TypeScript, Tailwind CSS, Bootstrap, Figma, Postman, Docker, and Git</strong> to deliver scalable and high-quality software. I pay attention to details because even small improvements can make a significant difference in usability and performance.',
    ],
    pageTitle: "About Me",
                            ...
                            <div className="relative">
                                ...
                                <div className="mt-4 sm:mt-6 text-center md:text-left">
                                    ...
                                    <p className="text-muted-foreground text-xs sm:text-sm mt-1">
                                        {data.location || "Baku, Azerbaijan (UTC+4)"}
                                    </p>
                                </div>
                            </div>
                        </div>
