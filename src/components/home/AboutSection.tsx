...
export const ProfileCard: React.FC = () => (
    <div className="shadow-feature-card rounded-2xl p-4 flex flex-col gap-3 relative overflow-hidden">
        ...
        <p className="text-foreground text-xl font-semibold">
            {MY_NAME} is a web-based Software Developer from Baku, Azerbaijan, specializing in building high-performance, elegant web applications using React, Vue, Laravel, and other modern web technologies.
        </p>
    </div>
);
